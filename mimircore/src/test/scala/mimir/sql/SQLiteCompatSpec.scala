...
/**
  ...
  */
object SQLiteCompatSpec extends Specification with FileMatchers {
  ...
  val reviewDataFiles = List(
    ...
    new File("../test/r_test/boolAnd.csv")
  )
...
}//pass sql statement to query should be sufficient: 'Select BoolAnd(arg) from R;'