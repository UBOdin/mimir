...
abstract case class Lens(iview: String, id: Int, params: List[String], source: Operator)
{
  ...
  def rowVar(vid: Int, args: List[Expression]) = PVar(iview, id, vid, Var("ROWID") :: args)
