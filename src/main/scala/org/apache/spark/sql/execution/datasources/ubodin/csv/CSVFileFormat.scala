...
class DefaultSource extends CSVFileFormat 
...
class CSVFileFormat extends TextBasedFileFormat with DataSourceRegister {
  ...
  override def isSplitable(
    ...
    val csvDataSource = MimirCSVDataSource(parsedOptions)
  ...
  override def inferSchema(
    ...
    MimirCSVDataSource(parsedOptions).inferSchema(sparkSession, files, parsedOptions)
  }
  ...
  override def buildReader(
    ...
    (file: PartitionedFile) => {
      ...
      val parser = new UnivocityParser(
        ...
        parsedOptions)
      MimirCSVDataSource(parsedOptions).readFile(
        conf,
        file,
        parser,
        requiredSchema,
