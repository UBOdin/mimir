 ...
 */
abstract class MimirCSVDataSource extends Serializable {
...
object MimirCSVDataSource extends Logging {
  def apply(options: CSVOptions): MimirCSVDataSource = {
...
object TextInputCSVDataSource extends MimirCSVDataSource {
  ...
  override def readFile(
    ...
    if (hasHeader) {
      ...
      CSVUtils.extractHeader(lines, parser.options).foreach { header =>
        ...
        MimirCSVDataSource.checkHeaderColumnNames(
          schema,
          columnNames,
          file.filePath,
...
object MultiLineCSVDataSource extends MimirCSVDataSource {
