...
private[csv] object CSVInferSchema {
  ...
  def infer(
    ...
    val outputSchema = fields ++ Array(
        StructField(mimir.lenses.mono.DataSourceErrors.DATASOURCE_ERROR_COLUMN.id, BooleanType, nullable = true), 
        StructField(mimir.lenses.mono.DataSourceErrors.DATASOURCE_ERROR_ROW_COLUMN.id, StringType, nullable = true))
